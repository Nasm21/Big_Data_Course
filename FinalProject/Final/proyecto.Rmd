...
```{r}
#Boxplot
ggplot(data_avo, aes(x =0 , y = Total.Volume)) +
  geom_boxplot(fill = "lightblue", color = "black", alpha = 0.7) +
    labs(title = "Histórico de volumen por año",
       x = "Volumen total",
       y = "Valor")

ggplot(data_avo, aes(x =0 , y = AveragePrice)) +
  geom_boxplot(fill = "lightblue", color = "black", alpha = 0.7) +
    labs(title = "Histórico de volumen por año",
       x = "Volumen total",
       y = "Valor")

ggplot(data_avo, aes(x =0 , y = calculada_Venta)) +
  geom_boxplot(fill = "lightblue", color = "black", alpha = 0.7) +
    labs(title = "Histórico de volumen por año",
       x = "Volumen total",
       y = "Valor")
...
datos_hist <- data_avo[, c("AveragePrice")]

datos_hist <- reshape2::melt(datos_hist)

ggplot(datos_hist, aes(x = value)) +
  geom_histogram(binwidth = 1, fill = "blue", color = "black", alpha = 0.7) +
  facet_wrap(~ variable, scales = "free") +
  labs(title = "Histogramas de varias variables",
       x = "Valor",
       y = "Frecuencia")

#hist(data_avo$X4046)
#hist(data_avo$Total.Bags)
